...
export default function MedicalVisaPage() {
  return (
    <div className="flex flex-col">
      ...
      <DestinationGrid
        title="Medical Visa Destinations"
        description="Destinations we process medical treatment visas for, including attendant visas for a companion. Tap any country for its requirements and processing time."
        destinations={destinationsFor("medical")}
      />
